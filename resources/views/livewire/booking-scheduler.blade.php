                    ...
                    <div class="mt-6 bg-white dark:bg-zinc-900/95 p-6 rounded-xl border border-gray-200 dark:border-zinc-700"
                        ...
                        <div class="mt-4 space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold text-gray-800 dark:text-white text-right">{{ count($selectedTimeSlots) }}
                                    jam</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600 dark:text-gray-300">Total Harga:</span>
                                <span class="font-bold text-lime-700 text-lg">Rp {{ number_format($this->totalPrice, 0, ',', '.') }}</span>
                            </div>
                        </div>
                ...
                @else
                    <div class="mt-6 text-center bg-lime-500 dark:bg-lime-500 p-4 rounded-lg">
                        <p class="text-white dark:text-white">
                            Anda harus <a href="{{ route('login') }}" class="font-bold underline">masuk</a> atau <a
                                href="{{ route('register') }}" class="font-bold underline">mendaftar</a> untuk melanjutkan pemesanan.
                        </p>
                    </div>
                @endauth
