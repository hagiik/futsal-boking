...
{{-- ====================================================== --}}
{{--                 VENUE MANAGEMENT SECTION START           --}}
{{-- ====================================================== --}}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-16">
            ...
            <div class="flex flex-col justify-center">
                ...
                <div class="flex items-center gap-2" data-aos="fade-right">
                    <button class="px-4 py-2 text-sm font-semibold rounded-full bg-red-800 text-white">
                        PEMILIK LAPANGAN
                    </button>
                ...
                <h2 class="mt-8 text-3xl md:text-4xl font-bold tracking-tight text-gray-900" data-aos="fade-right" data-aos-delay="100">
                    Kelola venue lebih praktis dan menguntungkan.
                </h2>

                <p class="mt-6 text-base md:text-lg leading-relaxed text-gray-600" data-aos="fade-right" data-aos-delay="200">
                    Waktunya buat venue anda lebih dari sekadar venue...
                </p>

                <a href="#" class="mt-8 inline-flex items-center gap-2 text-red-800 hover:text-red-900 font-semibold transition group" data-aos="fade-up" data-aos-delay="300">
                    Lihat Selengkapnya
...
<section class="bg-white dark:bg-zinc-900 py-16 sm:py-24 overflow-hidden" id="competitions">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        
        <div class="text-center">
            
            <h2 class="text-3xl font-bold tracking-tight text-red-800 dark:text-white sm:text-4xl" data-aos="fade-up">
