<x-layouts.app :title="__('Home')">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center w-full">
                ...
                <div>
                    <h1 class="text-5xl font-bold text-white md:text-6xl lg:text-7xl leading-tight">
                        Mulai Perjalanan Olahragamu di Sini
                    </h1>
                    <p class="mt-6 text-lg text-gray-200 max-w-lg">
                        Setiap hasil yang luar biasa dimulai dengan satu gerakan. Mari kita mulai.
                    </p>
                    <a href="{{ route('lapangan') }}"
                        class="mt-6 inline-block bg-lime-500 text-white font-semibold px-8 py-3 rounded-lg shadow hover:bg-lime-600 transition">
                        Mulai Sekarang
                    </a>
                    </div>
                <div class="flex flex-col items-start gap-4 mt-10 lg:mt-0 lg:items-end">
                    <div class="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-6 w-[300px] shadow-lg text-white">
                        <h3 class="text-xl font-semibold mb-2">Peralatan Unggulan</h3>
                        <p class="text-sm text-gray-200 mb-4">
                            Lihat peralatan kebugaran terbaik kami untuk membantu meningkatkan latihan Anda.
                            </p>
                    ...
                    <div class="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-6 w-[300px] shadow-lg text-white">
                        <h3 class="text-xl font-semibold mb-2">Tips Profesional</h3>
                        <p class="text-sm text-gray-200 mb-4">
                            Temukan tips dari para ahli untuk tetap termotivasi dan konsisten dalam berolahraga.
                            </p>
                            <a href="#" class="inline-block text-lime-400 font-medium hover:underline">
                            Baca Tips →
                            </a>
    ...
    <section class="bg-white dark:bg-zinc-900/50 py-16 sm:py-24">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center" data-aos="fade-up">
                <div>
                    <p class="text-sm font-bold uppercase tracking-wider text-lime-600 dark:text-lime-400">
                        TENTANG KAMI
                    </p>
                    <h2 class="mt-2 text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white">
                        Misi Kami Adalah Memberikan yang Terbaik
                    </h2>

                    <a href="#"
                        class="inline-block mt-8 bg-lime-500 text-white font-semibold px-8 py-3 rounded-lg shadow-md hover:bg-lime-600 transition-colors duration-300">
                        Selengkapnya
                    </a>
                    </div>
                <div class="text-gray-600 dark:text-gray-300 space-y-6 leading-relaxed">
                    <p>
                        Adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                        minim
                        veniam, quis nostrud exercitation ullamco. Lorem ipsum dolor sit amet, consectetur adipiscing
                        elit.
                    </p>
                    <p>
            ...
            <div class="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 dark:bg-zinc-700 rounded-xl overflow-hidden"
                data-aos="fade-up" data-aos-delay="200">
            
                <div class="bg-white dark:bg-zinc-800 p-8 flex flex-col" data-aos="fade-up" data-aos-delay="100">
                    <i data-lucide="dribbble" class="w-12 h-12 text-lime-600 dark:text-lime-400"></i>
                    <h3 class="mt-6 text-lg font-bold text-gray-900 dark:text-white">Peralatan Modern</h3>
                    <div class="mt-auto pt-4">
                        {{-- <i data-lucide="arrow-right" class="w-6 h-6 text-gray-400"></i> --}}
                    </div>
                </div>
                <div class="bg-white dark:bg-zinc-800 p-8 flex flex-col" data-aos="fade-up" data-aos-delay="200">
                    <i data-lucide="award" class="w-12 h-12 text-lime-600 dark:text-lime-400"></i>
                    <h3 class="mt-6 text-lg font-bold text-gray-900 dark:text-white">Pelatih Profesional</h3>
                    <div class="mt-auto pt-4">
                        {{-- <i data-lucide="arrow-right" class="w-6 h-6 text-gray-400"></i> --}}
                    </div>
                </div>
                <div class="bg-white dark:bg-zinc-800 p-8 flex flex-col" data-aos="fade-up" data-aos-delay="300">
                    <i data-lucide="user-check" class="w-12 h-12 text-lime-600 dark:text-lime-400"></i>
                    <h3 class="mt-6 text-lg font-bold text-gray-900 dark:text-white">Seleksi Raket Personal</h3>
                    <div class="mt-auto pt-4">
                        {{-- <i data-lucide="arrow-right" class="w-6 h-6 text-gray-400"></i> --}}
                    </div>
                </div>
                <div class="bg-white dark:bg-zinc-800 p-8 flex flex-col" data-aos="fade-up" data-aos-delay="400">
                    <i data-lucide="trophy" class="w-12 h-12 text-lime-600 dark:text-lime-400"></i>
                    <h3 class="mt-6 text-lg font-bold text-gray-900 dark:text-white">Kompetisi Lokal</h3>
                    <div class="mt-auto pt-4">
                        {{-- <i data-lucide="arrow-right" class="w-6 h-6 text-gray-400"></i> --}}
                    </div>
                </div>
    ...
    <section class="bg-white dark:bg-zinc-900/50 py-16 sm:py-24 overflow-hidden" id="competitions">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center">
                ...
                <p class="mt-4 max-w-full mx-auto text-lg leading-8 text-gray-600 dark:text-gray-400" data-aos="fade-up"
                    data-aos-delay="100">
                    Ikuti berbagai pilihan kompetisi dari AYO Indonesia dan operator kompetisi lainnya. Rasakan keseruan
                    silaturahmi di lapangan bersama ribuan tim amatir lainnya sekarang juga!
                </p>
                ...
                <div class="relative group overflow-hidden rounded-xl shadow-md" data-aos="zoom-in" data-aos-delay="300">
                    <div>
                        <img class="w-full h-full object-cover transition duration-500 group-hover:scale-110"
                            src="https://images.unsplash.com/photo-1583275478661-1c31970669fa?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt="Foto kompetisi 1">
                    
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                        <div
                            class="absolute bottom-0 left-0 right-0 p-6 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out">
                    ...
                    <div>
                        <img class="w-full h-full object-cover transition duration-500 group-hover:scale-110"
                            src="https://images.unsplash.com/photo-1722087642932-9b070e9a066e?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt="Foto kompetisi 2">
    ...
    <section class="bg-white dark:bg-zinc-900/50 py-16 sm:py-24 overflow-hidden">
                    ...
                    <div class="swiper review-slider">
                        <div class="swiper-wrapper py-4">
                            <div class="swiper-slide">
                                <figure class="bg-white dark:bg-zinc-800 p-6 rounded-2xl shadow-md h-full flex flex-col border border-gray-100">
                                    <blockquote class="text-gray-600 dark:text-gray-300 flex-grow">
                                        <p>"Booking lapangan jadi lebih mudah dan cepat. Sistem pembayarannya aman, dan
                                            yang paling penting lapangannya selalu sesuai dengan yang dijanjikan. Mantap!"
                                        </p>
                                        </blockquote>
                                        <div class="flex items-center gap-1 mt-4">
                                            @for ($i = 0; $i < 5; $i++)
                                            <svg class="w-6 h-6 text-yellow-400 dark:text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                                <path
                                                    d="M13.849 4.22c-.684-1.626-3.014-1.626-3.698 0L8.397 8.387l-4.552.361c-1.775.14-2.495 2.331-1.142 3.477l3.468 2.937-1.06 4.392c-.413 1.713 1.472 3.067 2.992 2.149L12 19.35l3.897 2.354c1.52.918 3.405-.436 2.992-2.15l-1.06-4.39 3.468-2.938c1.353-1.146.633-3.336-1.142-3.477l-4.552-.36-1.754-4.17Z" />
                                            </svg>
                            ...
                            <div class="swiper-slide">
                                <figure class="bg-white dark:bg-zinc-800 p-6 rounded-2xl shadow-md h-full flex flex-col border border-gray-100">
                                    <blockquote class="text-gray-600 dark:text-gray-300 flex-grow">
                                        <p>"Suka banget sama fitur cari tim sparring. Gak perlu lagi kesulitan nyari
                                            lawan tanding. Plus lapangannya selalu terawat dengan baik!"</p>
                                        </blockquote>
                                        <div class="flex items-center gap-1 mt-4">
                                            @for ($i = 0; $i < 5; $i++)
                                            <svg class="w-6 h-6 text-yellow-400 dark:text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <figcaption class="mt-6 flex items-center gap-x-4 border-t border-gray-100 dark:border-zinc-700 pt-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-gray-600 dark:text-gray-400 text-sm">1 minggu yang lalu
                                            </div>
                                            </div>
                                            </figcaption>
                                            </figure>
                            ...
                            <div class="swiper-slide">
                                <figure class="bg-white dark:bg-zinc-800 p-6 rounded-2xl shadow-md h-full flex flex-col border border-gray-100">
                                    <blockquote class="text-gray-600 dark:text-gray-300 flex-grow">
                                        <p>"Aplikasinya user friendly banget. Dari mulai booking sampai pembayaran smooth.
                                            Recommended buat yang sering main futsal!"</p>
                                        </blockquote>
                                        <div class="flex items-center gap-1 mt-4">
                                            @for ($i = 0; $i < 3; $i++)
                                            <svg class="w-6 h-6 text-yellow-400 dark:text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <figcaption class="mt-6 flex items-center gap-x-4 border-t border-gray-100 dark:border-zinc-700 pt-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-gray-600 dark:text-gray-400 text-sm">2 minggu yang lalu
                                            </div>
                                            </div>
                                            </figcaption>
                                            </figure>
        ...
        <section class="bg-white dark:bg-zinc-900/50 py-16 sm:py-24 overflow-hidden">
            <div class="container mx-auto px-4 text-center">
                ...
                <div class="mx-auto grid max-w-screen-xl grid-cols-2 gap-8 text-gray-500 dark:text-gray-400 sm:grid-cols-3 sm:gap-12 lg:grid-cols-6 px-4 mb-8"
                    data-aos="fade-right">
                ...
                {{-- <div class="" data-aos="fade-right">
                    <a href="#"
                        class="inline-block px-6 py-3 bg-lime-500 text-white font-semibold rounded-full hover:bg-lime-600 transition">
                        Become a Partner
                    </a>
                </div> --}}
            </div>
        ...
        <section class="relative bg-cover bg-center bg-no-repeat"
            style="background-image: url('https://images.unsplash.com/photo-1546519638-68e109498ffc?q=80&w=2090&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
            <div class="absolute inset-0 bg-black/50"></div>
            <div class="relative z-10 max-w-4xl mx-auto px-6 py-24 text-center text-white">
                <h2 class="text-4xl font-extrabold sm:text-5xl mb-6" data-aos="fade-up">
                    Bergabunglah Bersama Ribuan Tim Amatir di Indonesia!
                </h2>
                <p class="text-lg sm:text-xl mb-8" data-aos="fade-up" data-aos-delay="100">
                    Daftarkan tim Anda sekarang dan ikuti berbagai kompetisi seru bersama {{config('app.name')}}.
                </p>
                <a href="/daftar"
                    class="inline-block bg-lime-500 hover:bg-lime-600 text-white font-semibold px-8 py-4 rounded-lg shadow-lg transition duration-300"
                    data-aos="fade-up" data-aos-delay="200">
                    Daftar Sekarang
                </a>
    </div>
