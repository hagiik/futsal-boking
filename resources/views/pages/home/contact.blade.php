            ...
            <div class="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="bg-white dark:bg-zinc-800 p-8 rounded-2xl shadow-lg">
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" required class="mt-2 block w-full px-4 py-3 bg-gray-50 dark:bg-zinc-700 border-gray-300 dark:border-zinc-600 rounded-lg focus:ring-lime-500 focus:border-lime-500">
                        </div>
                         <div>
                            <label for="email" class="font-semibold text-gray-800 dark:text-gray-200">Alamat Email</label>
                            <input type="email" name="email" id="email" required class="mt-2 block w-full px-4 py-3 bg-gray-50 dark:bg-zinc-700 border-gray-300 dark:border-zinc-600 rounded-lg focus:ring-lime-500 focus:border-lime-500">
                        </div>
                         <div>
                            <label for="subject" class="font-semibold text-gray-800 dark:text-gray-200">Subjek</label>
                            <input type="text" name="subject" id="subject" required class="mt-2 block w-full px-4 py-3 bg-gray-50 dark:bg-zinc-700 border-gray-300 dark:border-zinc-600 rounded-lg focus:ring-lime-500 focus:border-lime-500">
                        </div>
                        <div>
                            <label for="message" class="font-semibold text-gray-800 dark:text-gray-200">Pesan Anda</label>
                            <textarea name="message" id="message" rows="5" required class="mt-2 block w-full px-4 py-3 bg-gray-50 dark:bg-zinc-700 border-gray-300 dark:border-zinc-600 rounded-lg focus:ring-lime-500 focus:border-lime-500"></textarea>
                        </div>
                        <div>
             ...
             <div class="mt-20">
                 <div class="aspect-w-16 aspect-h-9">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.241071191068!2d106.80486337593259!3d-6.23192006103389!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f143c4a67599%3A0x7fe4a9585a2ac5ac!2sPacific%20Century%20Place!5e0!3m2!1sen!2sid!4v1720880029813!5m2!1sen!2sid"
                        width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                        class="rounded-2xl shadow-lg"></iframe>
                 </div>
            </div>
