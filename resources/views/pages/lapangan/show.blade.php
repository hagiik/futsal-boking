            ...
            <div class="lg:col-span-3">
                ...
                <div
                    ...
                    <div class="">
                        ...
                        <span
                            class="mt-2 inline-block bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">
                        ...
                        <div class="mt-4 grid grid-cols-2 sm:grid-cols-3 gap-4">
                            @foreach($field->facilities as $facility)
                                <div class="flex items-center gap-3">
                                    <div
                                        class="p-2 bg-red-100 dark:bg-red-900/50 rounded-full flex items-center justify-center">
                                        <i data-lucide="{{ $facility->icon }}"
                                            class="w-5 h-5 text-red-700 dark:text-red-300"></i>
                                    </div>
                                    <span
