<nav x-data="{ open: false }" class="bg-white/95 dark:bg-zinc-900/95 border-b border-gray-200 dark:border-gray-600 sticky top-0 w-auto mx-auto z-50 py-2">
    <div class="container mx-auto flex flex-wrap items-center justify-between p-4">
        ...
        <div class="flex items-center">
            ...
            <div class="hidden md:flex items-center ml-10 space-x-8">
                ...
                <a href="#" class="block py-2 px-3 rounded-sm md:p-0
                        {{ request()->routeIs('#') ? 'text-sm font-medium text-lime-700 underline decoration-lime-500 decoration-2 underline-offset-4 md:bg-transparent md:text-lime-500 md:dark:text-lime-500 dark:bg-lime-600 md:dark:bg-transparent' : 'text-sm font-medium text-gray-700 md:hover:text-lime-500 dark:text-gray-100 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent hover:underline hover:decoration-lime-500 hover:decoration-2 hover:underline-offset-4' }}">Partner With Us</a>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="h-6 w-px bg-zinc-300 dark:bg-zinc-600"></div>
                @guest
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('login') }}" class="text-sm font-medium text-gray-700 hover:text-lime-600 dark:text-gray-300 dark:hover:text-lime-500">Masuk</a>
                        <a href="{{ route('register') }}" class="bg-lime-500 hover:bg-lime-600 text-white text-sm font-semibold px-5 py-2.5 rounded-lg transition-colors">Daftar</a>
                    </div>
                @endguest
    ...
    <div x-show="open" 
        ...
        <div class="px-4 pt-2 pb-4 space-y-2">
            <a href="{{route('lapangan')}}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-zinc-800">Cari lapangan</a>
            ...
            <div class="border-t border-gray-200 dark:border-gray-600 pt-4 mt-4 flex items-center space-x-4">
                @guest
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('register') }}" class="flex-1 text-center bg-lime-700 text-white font-semibold py-2 px-4 rounded-lg">Daftar</a>
                    </div>
                @endguest
                @auth
                    <div class="space-y-2">
